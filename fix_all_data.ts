...
if (!projectsContent.includes('the-fitters')) {
  // Find the last ]
  const lastBracketIndex = projectsContent.lastIndexOf(']');
  if (lastBracketIndex !== -1) {
    ...
    projectsContent = projectsContent.substring(0, lastBracketIndex) + projectToAdd + '\n];';
...
if (!caseStudiesContent.includes('the-fitters')) {
  const lastBracketIndex = caseStudiesContent.lastIndexOf(']');
  if (lastBracketIndex !== -1) {
    ...
    caseStudiesContent = caseStudiesContent.substring(0, lastBracketIndex) + caseStudyToAdd + '\n];';
...
if (!testimonialsContent.includes('the-fitters')) {
  const lastBracketIndex = testimonialsContent.lastIndexOf(']');
  if (lastBracketIndex !== -1) {
    ...
    testimonialsContent = testimonialsContent.substring(0, lastBracketIndex) + testimonialToAdd + '\n];';
